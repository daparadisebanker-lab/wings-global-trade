# apps/escalera — El Pasillo (tile catalogue)

The supplier's tile catalogue as an **aisle you walk**, not a PDF you pinch.
Extends the root `CLAUDE.md` (ecosystem law); this file is the app-specific law
...
- Rebuild: `python infrastructure/escalera/build_catalog.py --data-only`.
