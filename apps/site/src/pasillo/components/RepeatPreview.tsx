...
import { canRandomiseRepeat, faceAt } from '@/pasillo/lib/catalogue'
...
export function RepeatPreview({ sku, compact = false }: { sku: Sku; compact?: boolean }) {
  ...
  return (
    <div>
      <div className="relative aspect-square w-full overflow-hidden bg-pas-surface-2">
        {mode === '1x' ? (
      ...
      <div className="mt-3 flex items-center gap-2">
        <div role="radiogroup" aria-label="Vista" className="flex rounded-pas-chrome border border-pas-ink/20 p-1">
