  ...
  return (
    ...
    >
      ...
      <div className="mx-auto flex max-w-6xl items-center gap-1 overflow-x-auto px-5 md:px-8">
        {brand ? (
          // Breadcrumb mode
          <div className="flex items-center gap-2 py-3.5 font-mono text-[11px] uppercase tracking-widest-2">
          ...
          <>
            ...
            <Link
              href="/cotizar"
              className="ml-auto shrink-0 whitespace-nowrap py-3.5 pl-3 font-mono text-[11px] uppercase tracking-widest-2 text-[color:var(--accent-ink)]"
            >
              Cotizar →
            </Link>
          </>
