  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-[calc(3.5rem+1.5rem)] left-6 z-40 flex items-center gap-2 bg-navy px-4 py-3 font-mono text-[11px] uppercase tracking-nav text-warm-white shadow-card-hover transition-all hover:bg-navy-light lg:bottom-6"
      >
