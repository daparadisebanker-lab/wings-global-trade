// @wings/trade-ui · Button primitive. Extracted verbatim from apps/site
// components/ui/button.tsx (M3b).
'use client'
...
const variants: Record<Variant, string> = {
  ...
  secondary: 'bg-transparent border border-current hover:bg-current/[0.06]',
