// @wings/trade-ui · Select primitive. Extracted verbatim from apps/site
// components/ui/select.tsx (M3b). DESTINATION_COUNTRIES stays app-side (lane
// content) and is injected where needed.
