// @wings/mister · useMisterStream — raw SSE streaming hook for Mister v2.
// Parses NAMED SSE events from POST /api/mister (the endpoint stays in apps/site;
// this is the client consumer only — no guardrail logic). Moved verbatim from
// apps/site src/hooks/useMisterStream.ts (M3c); app re-exports it.
