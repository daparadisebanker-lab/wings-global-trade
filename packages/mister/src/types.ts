// @wings/mister · types — the Mister v2 data contract (client surface).
// Moved verbatim from apps/site src/types/mister.ts (M3c). apps/site re-exports
// this via src/types/mister.ts so all 11 server importers + client are unchanged.
...
import type { FreeZone, TprCompleteness, ConversationTurn } from './database-shared'
