...
1x Toyota Hilux Travo Overland Plus, client Inversiones Arompech SRL
(representante Arnulfo Aroni Miranda).

Adapted from cotizacion-travo-alipio-randa/build_cotizacion.py: same
cost-engine inputs/derivation and per-unit sale price (USD 55,211.87),
reduced to UNITS = 1 — cantidad no fue especificada por el cliente, se
asume 1 unidad siguiendo la misma convención usada para clientes previos
sin cantidad indicada.

Client data provided (WhatsApp, 2026-09-12):
  DNI 08294636 · ARNULFO ARONI MIRANDA · Lima, Santa Anita ·
  Av. La Cultura 808, Interior pabellón C - puesto 017 ·
  Empresa INVERSIONES AROMPECH SRL · RUC 20535835986
The RUC identifies the buying entity (empresa); Arnulfo Aroni Miranda
(DNI) is recorded as the representante/contacto — same treatment as a
company party box elsewhere in this project (RUC + contact name).
...
DOC_NUMBER = "COT-WGT-2026-0913"
FECHA = "Lima, 12-09-2026"

# ── Client (WhatsApp, 2026-09-12) ───────────────────────────────────────
...
# Same commercial rounding adjustment as the standing Overland Plus
# quotations, kept for pricing consistency across quotes for this vehicle.
