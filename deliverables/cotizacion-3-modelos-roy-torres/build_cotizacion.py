...
Roy Torres (DNI 73471021, Cerro de Pasco) listing THREE Hilux models side
by side — 4x4 automática (Travo Overland Plus), 4x4 mecánica básica
(Básica Manual 4x4) and 4x4 mecánica full (Full Manual 4x4) — per-unit
pricing only, no summed grand total, same table format used for the
...
docstring and `deliverables/PRICING_NOTES.md` for the full derivation
(shared cost inputs; Overland Plus keeps its standing +48.24/unit
commercial-rounding price; Full Manual 4x4 / Básica Manual 4x4 use the
engine's raw 10%-margin output).
...
DOC_NUMBER = "COT-WGT-2026-0924"
FECHA = "Lima, 24-09-2026"

CLIENTE_NOMBRE = "Roy Torres"
CLIENTE_DNI = "73471021"
CLIENTE_CIUDAD = "Cerro de Pasco"
...
MODELOS = [
    ("Toyota Hilux Travo Overland Plus — 4x4 Automática", "2.8L Diésel 4WD Automática", sale_overland_plus),
    ("Toyota Hilux Full Manual 4x4 — 4x4 Mecánica Full", "2.8L Diésel Manual 4WD", sale_full_manual),
    ("Toyota Hilux Básica Manual 4x4 — 4x4 Mecánica Básica", "2.8L Diésel Manual 4WD", sale_basica_manual),
]
