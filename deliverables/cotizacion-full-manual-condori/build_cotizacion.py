...
1x Toyota Hilux Full Manual 4x4, client Percy Condori (Juliaca).
...
same standing per-unit price already quoted to Elis.

Client provided: Percy Condori · Juliaca. No DNI, no empresa/RUC were
given, so none are shown (house rule: never fabricate client data).
Cantidad explicitly stated as 1 unidad.
...
CLIENTE = "Percy Condori"
CLIENTE_CIUDAD = "Juliaca"
DOC_NUMBER = "COT-WGT-2026-0914-E"
