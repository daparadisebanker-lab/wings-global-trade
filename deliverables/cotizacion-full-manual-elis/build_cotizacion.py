...
1x Toyota Hilux Full Manual 4x4, client Elis (DNI 40748085, Arequipa).

Cost basis identical to cotizacion-3-modelos-arompech/build_cotizacion.py
and recorded in `deliverables/PRICING_NOTES.md`: FOB 44,205.00, same
shared freight/portuario/agencia/seguro/IGV/percepción/T.C./margen 10% as
the Hilux Travo Overland Plus costeo, no extra rounding adjustment (that
+48.24/unit adjustment is specific to the Overland Plus model only).

Client provided: Elis (first name only) · DNI 40748085 · Arequipa. No
apellido, no empresa/RUC were given, so none are shown (house rule: never
fabricate client data). Cantidad not specified — assumed 1 unidad, same
convention used for other individual-client quotes this session.
...
CLIENTE = "Elis"
CLIENTE_DNI = "40748085"
CLIENTE_CIUDAD = "Arequipa"
DOC_NUMBER = "COT-WGT-2026-0914-D"
FECHA = "Lima, 14-09-2026"
MODEL_NAME = "Toyota Hilux Full Manual 4x4"
MODEL_DESC = "2.8L Diésel Manual 4WD"
...
<title>Cotización · Wings Global Trade · Toyota Hilux Full Manual 4x4</title>
<style>
  :root {{
