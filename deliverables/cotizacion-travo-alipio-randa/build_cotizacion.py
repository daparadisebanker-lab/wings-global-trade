...
1x Toyota Hilux Travo Overland Plus, client Alipio Rony Randa.

Adapted from cotizacion-hilux-travo-overland-plus/build_cotizacion.py: same
cost-engine inputs/derivation (FOB 43,000 · Flete Int'l 5,250 · origen
Tailandia · Ad Valorem 0% · ISC 0% diésel · Zofratacna/portuarios/agencia ·
Seguro 1.5% · IGV 18% · Percepción 3.5% · T.C. 3.70 · margen 10% + el mismo
ajuste comercial +48.24/unidad ya usado en la cotización estándar de 2
unidades), reduced to UNITS = 1 per this client's request (no cantidad fue
especificada por el cliente; se asume 1 unidad, siguiendo la misma
convención usada para Pablo Peláez / Prado Hybrid). Client's país was not
provided, so it is omitted rather than guessed (house rule — never
fabricate client data).
...
CLIENTE = "Alipio Rony Randa"
DOC_NUMBER = "COT-WGT-2026-0912"
...
# Same commercial rounding adjustment as the standing 2-unit Overland Plus
# quotation, kept for pricing consistency across quotes for this vehicle.
