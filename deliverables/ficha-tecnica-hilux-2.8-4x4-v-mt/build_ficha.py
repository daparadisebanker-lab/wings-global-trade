...
for the Toyota Hilux 2.8 4x4 V M/T.
...
used on other fichas is left out here rather than guessed.
Run:
...
MODEL_NAME = "Toyota Hilux 2.8 4x4 V M/T"
...
SECTIONS = [
    (1, "Identificación", [
        ("Modelo", "Toyota Hilux"),
        ("Versión", "2.8 4x4 V M/T — 2.8L Diésel · 4x4 · Manual de 6 velocidades con iMT"),
    ...
    (2, "Dimensiones y Pesos", [
        ...
        ("Altura mínima al suelo (mm)", "312"),
        ("Capacidad del tanque de combustible (L)", "80"),
    ]),
    (3, "Motor y Transmisión", [
        ("Motor", "1GD-FTV (High): 2.8L Diésel, 4 cilindros, 16 válvulas DOHC, turbo de boquilla variable con intercooler enfriado por aire"),
        ("Cilindrada (cc)", "2,755"),
    ...
    (5, "Exterior e Iluminación", [
        ("Faros delanteros", "LED, con nivelación automática"),
    ...
    (6, "Interior, Confort y Tecnología", [
        ...
        ("Toma de 12V", "1"),
        ("Cargador inalámbrico", "Delantero, incluido"),
...
<title>Ficha Técnica · Wings Global Trade · Toyota Hilux 2.8 4x4 V M/T</title>
<style>
  :root {{
...
<article class="pdoc">
  ...
  <div class="pdoc-tail">
  <p class="pdoc-note">Especificaciones según catálogo global Toyota Hilux ICE, variante 2.8 4x4 V M/T; pueden variar según lote de producción y mercado. Se recomienda confirmar contra la unidad física antes de la compra.</p>
