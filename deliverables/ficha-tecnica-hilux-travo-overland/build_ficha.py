...
for the Toyota Hilux Travo Overland — a custom nameplate for the Chinese-
market "Hilux Trailhunter 2.8 4x4 AT" bilingual (CN/EN) spec sheet supplied
by the client. TEXT-ONLY, no photography, no supplier named. Reuses the same
`pdoc` grid/logo/footer and the audit-informed typography (real type scale,
check-badge for boolean specs) built for the Prado ficha-simple. Run:
...
DOC_NUMBER = "FT-WGT-2026-0813"
DOC_DATE = "13-08-2026"

MODEL_NAME = "Toyota Hilux Travo Overland"
MODEL_TRIM = "2.8 Turbodiésel · 4WD · Automática de 6 velocidades"

HERO_STATS = [
    ("Potencia máxima", "150 kW (204 HP)"),
    ("Torque máximo", "500 N·m"),
    ("Transmisión", "6AT"),
    ("Tracción", "4WD electrónico"),
]
...
SECTIONS = [
    ...
    (2, "Dimensiones y Pesos", [
        ("Longitud × Ancho × Alto (mm)", "5,320 × 1,855 × 2,005"),
        ("Distancia entre ejes (mm)", "3,085"),
        ("Distancia libre al suelo (mm)", "295"),
        ("Radio de giro mínimo (m)", "6.4"),
        ("Peso en orden de marcha (kg)", "2,095"),
        ("Peso bruto vehicular (kg)", "2,950"),
    ]),
    (3, "Motor y Transmisión", [
        ("Cilindrada (cc)", "2,755"),
        ("Potencia máxima (kW / RPM)", "150 / 3,000–3,400"),
        ("Torque máximo (N·m / RPM)", "500 / 1,600–2,800"),
        ("Transmisión (Tipo)", "Automática de 6 velocidades"),
        ("Tracción", "4WD electrónico, tiempo parcial (part-time)"),
        ("Sistema Multi-Terrain Select",
         "Nieve, Barro, Arena, Grava y modo Automático"),
    ]),
    (4, "Chasis, Frenos y Neumáticos", [
        ("Frenos (Delanteros)", "Discos ventilados"),
        ("Frenos (Posteriores)", "Discos"),
        ("Freno de estacionamiento", "Electrónico"),
        ("Neumáticos / Aros (Medida)", "265/60 R18"),
    ...
    (5, "Seguridad Activa y Asistencia a la Conducción", [
        ...
        ("Control crucero", "Sí"),
        ("Cámara de reversa", "Sí, cámara 360° / vista panorámica (PVM)"),
        ("Sensores de estacionamiento", "Sí, delanteros y traseros"),
    ]),
    (6, "Seguridad Pasiva", [
        ("Airbags frontales (piloto y copiloto)", "Sí"),
        ("Airbag de rodilla (piloto)", "Sí"),
        ("Airbags laterales delanteros", "Sí"),
        ("Cortinas de aire (delanteras y traseras)", "Sí"),
        ("Airbags laterales traseros", "Sí"),
    ]),
    (7, "Equipamiento Interior", [
        ...
        ("Apoyabrazos trasero", "Sí"),
        ("Timón (Material)", "Cuero"),
        ("Timón (Ajuste)", "Manual, 4 direcciones (altura + profundidad)"),
        ("Controles en el timón",
         "Audio, pantalla multiinformación, manos libres, crucero adaptativo (DRCC), alerta de carril (LDA)"),
        ...
        ("Llave inteligente", "Sí"),
        ("Encendido", "Botón de arranque (Push Start)"),
        ("Freno de mano", "Electrónico (EPB) + Auto Hold"),
        ("Ventanas eléctricas", "4 puertas"),
        ("Instrumental", "Pantalla TFT a color"),
        ("Indicador de consumo de combustible", "Sí"),
        ("Pantalla multiinformación", "Sí"),
    ]),
    (8, "Equipamiento Exterior e Iluminación", [
        ("Faro bajo (Luz de cruce)", "LED tipo proyector, doble lente"),
        ("Faro alto (Luz de carretera)", "LED tipo proyector, doble lente"),
        ("Luces diurnas (DRL)", "LED"),
        ("Ajuste de altura de faros", "Automático"),
        ("Luz de bienvenida (Welcome light)", "Sí"),
        ("Control automático de luces", "Sí"),
        ("Alerta de luces encendidas", "Sí"),
        ("Nivelación de faros", "Sí"),
        ("Desempañador de luna trasera", "Sí"),
        ("Faros antiniebla delanteros", "Sí"),
        ("Luces traseras", "LED"),
        ("Luz de freno superior (Stop LED)", "LED"),
        ("Espejos exteriores",
         "Eléctricos, plegado eléctrico, luz de giro integrada, luz de bienvenida integrada"),
    ]),
]


def value_html(value: str) -> str:
    """Boolean specs (the source sheet marks these with '●') get a check
    badge instead of plain 'Sí' text — same scannability fix applied to the
    Prado ficha-simple, matching the design audit's finding."""
...
<title>Ficha Técnica · Wings Global Trade · Toyota Hilux Travo Overland</title>
<style>
  :root {{
