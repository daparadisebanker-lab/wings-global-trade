...
Alex Rojas (Chiclayo) listing THREE Hilux models side by side, per-unit
pricing only — no summed grand total, same table format requested for the
Inversiones Arompech SRL / Abraham Pinares cotizaciones.
...
Client provided (no DNI, no empresa/RUC — house rule: never fabricate
client data not explicitly given):
  Alex Rojas · Chiclayo
...
DOC_NUMBER = "COT-WGT-2026-0914-C"
FECHA = "Lima, 14-09-2026"

CLIENTE_NOMBRE = "Alex Rojas"
CLIENTE_CIUDAD = "Chiclayo"
