  ...
  return (
    <>
      ...
      <div className="space-y-2">
        <div
          className="group relative aspect-square w-full cursor-zoom-in overflow-hidden rounded-2xl bg-[#EEE9E0]"
          ...
          <div className="flex gap-2 overflow-x-auto pb-1">
            {images.map((src, i) => (
              <button
                ...
                type="button"
                onClick={() => setActive(i)}
                className={`relative aspect-square w-24 flex-shrink-0 overflow-hidden rounded-xl border-2 bg-[#EEE9E0] transition-all ${
                  i === active
                    ? "border-[#C4933F]"
      ...
      {lightbox && (
        ...
        >
          ...
          <div
            className="relative mx-4 aspect-square w-full max-w-5xl sm:mx-16"
