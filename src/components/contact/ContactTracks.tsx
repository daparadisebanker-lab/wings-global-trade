        ...
        <div className="space-y-5">
          ...
          <div className="rounded-2xl bg-[#004389] p-7 text-white">
            ...
            <a
              ...
              className="flex w-full items-center justify-center gap-2 rounded-full py-3 text-xs font-semibold uppercase tracking-widest text-white transition-opacity hover:opacity-90"
