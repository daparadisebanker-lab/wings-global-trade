        ...
        <div className="relative flex flex-1 flex-col px-10 py-8 pl-[54px]">
          ...
          <div ref={ctaRef} className="mt-auto pt-10" style={{ opacity: 0 }}>
            ...
            <a
              ...
              className="mt-3 flex h-14 w-full items-center justify-center gap-3 border border-[#25D366]/30 bg-[#25D366]/10 uppercase tracking-[0.14em] text-[#25D366] transition-colors duration-200 hover:bg-[#25D366]/18 hover:border-[#25D366]/50"
              style={{ fontFamily: "var(--font-data)", fontSize: "var(--type-data)" }}
            >
